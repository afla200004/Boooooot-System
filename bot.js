 ...
 **
 ...
 Admins Commands
 =================
 -muute  ===> لاٍعطاء الميوت 
 -unmute ===> ل فك الميوت 
 -ban    ===> ل طرد الشخص 
 -kick   ===> ل طرد الشخص مؤقتا
 -mutechannel ===> ل أغلاق الشات 
 -unmutechannel ===> ل فتح الشات 
 -warn ===> لاٍعطاء اٍنذار للشخص 
...
client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('**Bot Owner**👑 :' , `[<@482179798425403402>]` , true)
            .setFooter(message.author.username, message.author.avatarURL)
    })
}
});
